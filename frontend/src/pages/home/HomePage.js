          ...
          <div className="products-grid">
            {bestSellingProducts.map((product) => {
              const isFavorite = favorites.some(
                (favId) => String(favId) === String(product.id),
              );
              return (
          ...
          <div className="feedback-list">
            <div className="feedback-card">
              <div className="feedback-content">
                ...
                Sản phẩm nhẹ, dễ bảo quản và rất nổi bật. Đóng gói rất cẩn
                thận."
              </div>
            ...
            <div className="feedback-card">
              <div className="feedback-content">
                "Mùi nến thơm rất dễ chịu, không bị gắt như các loại nến công
                nghiệp. Hũ nến xinh xắn, dùng làm quà tặng rất hợp lý."
              </div>
              <div className="feedback-author">
            ...
            <div className="feedback-card">
              <div className="feedback-content">
                "Túi vải rất dày dặn, đường may chắc chắn. Mình dùng đi học hàng
                ngày đựng rất nhiều sách vở mà vẫn bền. Sẽ ủng hộ shop dài dài."
              </div>
              <div className="feedback-author">
